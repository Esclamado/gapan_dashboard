            ...
            if ($photo) {
                ...
                if ($save) {
                    ...
                    if ($to) {
                        ...
                        /* send notif to inspector */
                        $this->_cfs->save($this->getPost('receiver_id'), $sorter, $message, 'sorter_file_incident_report', $this->_siteConfig->getData('site_firebase_project_id'), $this->_siteConfig->getData('site_firebase_web_api_key'));
