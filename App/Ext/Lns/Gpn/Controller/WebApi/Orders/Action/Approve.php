...
class Approve extends \Lns\Sb\Controller\Controller{
                ...
                if($save){
                    ...
                    switch($orderStatus){
                        ...
                        case 2: /* Approved */
                            ...
                            $this->_orders->sendEmailorderstatus($update->getData('user_id'), $this->_siteConfig, 'approve_order', $orderId);
