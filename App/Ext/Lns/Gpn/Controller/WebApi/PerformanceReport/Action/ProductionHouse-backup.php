...
class ProductionHouse extends \Lns\Sb\Controller\Controller {
    ...
    public function run() {
        ...
        if($payload['error'] == 1){
            ...
            $total_count = $this->_daily_sorting_report->getHarvestedProductionPerHouse($param, true);
            if ($reports) {
                $i = 0;
                ...
                foreach($reports['datas'] as $report) {
                    ...
                    if ($houses) {
                        ...
                        foreach($houses as $house) {
                            ...
                            $report = $this->_daily_sorting_report->getHarvestedProductionByHouseDate($house->getData('id'), $grouped_date);
